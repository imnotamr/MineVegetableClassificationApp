...
def load_trained_model():
    ...
    model_url = "https://github.com/imnotamr/Vegetable-Classification-App/releases/download/v1.0/Vegetable_model_compatible.h5"
    model_path = "Vegetable_model_compatible.h5"
